...
class AD9910_WAVE_RAM_AMP_W(Process):
    """
    write amplitude parameters into AD9910 DRAM
    1024 * 32
    """

    def __init__(self, bits, RAM_AMP:list[int]):
        super().__init__(bits)								

        # RAM profile register 0 data
        CFR1_init_data = [0x60,0x40,0x00,0x00]
        RAM_PRO0_data = [0x00,0x00,0x01,0xff,0xC0,0x00,0x00,0x00]
        ...
        # write RAM process
        write_RAM_process = Write_RAM(self.bits,RAM_data=RAM_AMP)
